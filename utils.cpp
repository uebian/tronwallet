...
const std::string parseStringRet(const unsigned char* buf,unsigned long long argOffset)
{
    boost::multiprecision::uint256_t offset=getUint256FromBuffer(buf+argOffset);
