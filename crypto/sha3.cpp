...
void
sha3_Update(void *priv,const unsigned char *bufIn, size_t len)
{
    sha3_context *ctx = (sha3_context *) priv;
...
sha3_return_t sha3_HashBuffer( unsigned bitSize, enum SHA3_FLAGS flags, const unsigned char *in, unsigned inBytes, void *out, unsigned outBytes ) {
    sha3_return_t err;
    sha3_context c;
