...
namespace google {
namespace api {
constexpr LogDescriptor::LogDescriptor(
...
struct LogDescriptorDefaultTypeInternal {
  constexpr LogDescriptorDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT LogDescriptorDefaultTypeInternal _LogDescriptor_default_instance_;
}  // namespace api
}  // namespace google
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fapi_2flog_2eproto = {
  false, false, 293, descriptor_table_protodef_google_2fapi_2flog_2eproto, "google/api/log.proto", 
  ...
  file_level_metadata_google_2fapi_2flog_2eproto, file_level_enum_descriptors_google_2fapi_2flog_2eproto, file_level_service_descriptors_google_2fapi_2flog_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_google_2fapi_2flog_2eproto_getter() {
  return &descriptor_table_google_2fapi_2flog_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_google_2fapi_2flog_2eproto(&descriptor_table_google_2fapi_2flog_2eproto);
namespace google {
namespace api {
...
void LogDescriptor::ArenaDtor(void* object) {
  LogDescriptor* _this = reinterpret_cast< LogDescriptor* >(object);
  (void)_this;
}
void LogDescriptor::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
void LogDescriptor::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to,
                      const ::PROTOBUF_NAMESPACE_ID::Message&from) {
  static_cast<LogDescriptor *>(to)->MergeFrom(
      static_cast<const LogDescriptor &>(from));
}
