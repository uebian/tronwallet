...
class AuthenticationRule final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::OAuthRequirements* release_oauth();
...
class JwtLocation final :
 ...
 public:
  ...
  inline JwtLocation* New() const final {
    return new JwtLocation();
  }

  JwtLocation* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_value_prefix();
...
class AuthProvider final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_issuer();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_jwks_uri();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_audiences();
...
class OAuthRequirements final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_canonical_scopes();
