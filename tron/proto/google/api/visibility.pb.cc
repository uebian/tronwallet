...
constexpr VisibilityRule::VisibilityRule(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : selector_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string)
  , restriction_(&::PROTOBUF_NAMESPACE_ID::internal::fixed_address_empty_string){}
struct VisibilityRuleDefaultTypeInternal {
  constexpr VisibilityRuleDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT VisibilityRuleDefaultTypeInternal _VisibilityRule_default_instance_;
}  // namespace api
}  // namespace google
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fapi_2fvisibility_2eproto = {
  false, false, 845, descriptor_table_protodef_google_2fapi_2fvisibility_2eproto, "google/api/visibility.proto", 
  ...
  file_level_metadata_google_2fapi_2fvisibility_2eproto, file_level_enum_descriptors_google_2fapi_2fvisibility_2eproto, file_level_service_descriptors_google_2fapi_2fvisibility_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_google_2fapi_2fvisibility_2eproto_getter() {
  return &descriptor_table_google_2fapi_2fvisibility_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_google_2fapi_2fvisibility_2eproto(&descriptor_table_google_2fapi_2fvisibility_2eproto);
namespace google {
namespace api {
...
void VisibilityRule::InternalSwap(VisibilityRule* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &restriction_, GetArenaForAllocation(),
      &other->restriction_, other->GetArenaForAllocation()
  );
}
