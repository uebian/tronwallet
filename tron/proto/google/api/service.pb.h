...
class Service final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_producer_project_id();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Documentation* release_documentation();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Backend* release_backend();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Http* release_http();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Quota* release_quota();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Authentication* release_authentication();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Context* release_context();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Usage* release_usage();
  ...
  PROTOBUF_DEPRECATED bool has_config_version() const;
  private:
  bool _internal_has_config_version() const;
  public:
  PROTOBUF_DEPRECATED void clear_config_version();
  PROTOBUF_DEPRECATED const PROTOBUF_NAMESPACE_ID::UInt32Value& config_version() const;
  PROTOBUF_MUST_USE_RESULT PROTOBUF_DEPRECATED PROTOBUF_NAMESPACE_ID::UInt32Value* release_config_version();
  PROTOBUF_DEPRECATED PROTOBUF_NAMESPACE_ID::UInt32Value* mutable_config_version();
  PROTOBUF_DEPRECATED void set_allocated_config_version(PROTOBUF_NAMESPACE_ID::UInt32Value* config_version);
  private:
  ...
  public:
  PROTOBUF_DEPRECATED void unsafe_arena_set_allocated_config_version(
      PROTOBUF_NAMESPACE_ID::UInt32Value* config_version);
  PROTOBUF_DEPRECATED PROTOBUF_NAMESPACE_ID::UInt32Value* unsafe_arena_release_config_version();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Control* release_control();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Billing* release_billing();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Logging* release_logging();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::Monitoring* release_monitoring();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::SystemParameters* release_system_parameters();
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::SourceInfo* release_source_info();
...
void Service::set_producer_project_id(ArgT0&& arg0, ArgT... args) {
 ...
 producer_project_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& Service::_internal_producer_project_id() const {
  return producer_project_id_.Get();
}
inline void Service::_internal_set_producer_project_id(const std::string& value) {
  
  producer_project_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Service::_internal_mutable_producer_project_id() {
  
  return producer_project_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Service::release_producer_project_id() {
  ...
  return producer_project_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void Service::set_allocated_producer_project_id(std::string* producer_project_id) {
  ...
  producer_project_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), producer_project_id,
      GetArenaForAllocation());
