...
class MetricDescriptor_MetricDescriptorMetadata final :
 ...
 public:
  ...
  explicit constexpr MetricDescriptor_MetricDescriptorMetadata(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline MetricDescriptor_MetricDescriptorMetadata* New() const final {
    return new MetricDescriptor_MetricDescriptorMetadata();
  }
  ...
  PROTOBUF_MUST_USE_RESULT PROTOBUF_NAMESPACE_ID::Duration* release_sample_period();
  ...
  PROTOBUF_MUST_USE_RESULT PROTOBUF_NAMESPACE_ID::Duration* release_ingest_delay();
...
class MetricDescriptor final :
 ...
 public:
  ...
  explicit constexpr MetricDescriptor(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::google::api::MetricDescriptor_MetricDescriptorMetadata* release_metadata();
...
public:
  ...
  explicit constexpr Metric_LabelsEntry_DoNotUse(
...
inline void MetricDescriptor::set_allocated_metadata(::google::api::MetricDescriptor_MetricDescriptorMetadata* metadata) {
  ...
  if (metadata) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::api::MetricDescriptor_MetricDescriptorMetadata>::GetOwningArena(metadata);
    if (message_arena != submessage_arena) {
...
inline void MetricDescriptor::set_monitored_resource_types(int index, std::string&& value) {
  monitored_resource_types_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:google.api.MetricDescriptor.monitored_resource_types)
}
...
inline void MetricDescriptor::add_monitored_resource_types(std::string&& value) {
  monitored_resource_types_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:google.api.MetricDescriptor.monitored_resource_types)
}
