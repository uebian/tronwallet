...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_core_2fTronInventoryItems_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::protocol::InventoryItems)},
};
...
::PROTOBUF_NAMESPACE_ID::uint8* InventoryItems::_InternalSerialize(
