...
class PingMessage final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::protocol::Endpoint* release_from();
  ...
  PROTOBUF_MUST_USE_RESULT ::protocol::Endpoint* release_to();
...
inline ::PROTOBUF_NAMESPACE_ID::int32 PingMessage::_internal_version() const {
  return version_;
}
...
inline void PingMessage::_internal_set_version(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 PongMessage::_internal_echo() const {
  return echo_;
}
...
inline void PongMessage::_internal_set_echo(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 FindNeighbours::_internal_timestamp() const {
  return timestamp_;
}
...
inline void FindNeighbours::_internal_set_timestamp(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 Neighbours::_internal_timestamp() const {
  return timestamp_;
}
...
inline void Neighbours::_internal_set_timestamp(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 BackupMessage::_internal_priority() const {
  return priority_;
}
...
inline void BackupMessage::_internal_set_priority(::PROTOBUF_NAMESPACE_ID::int32 value) {
