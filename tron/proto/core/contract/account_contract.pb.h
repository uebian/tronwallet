...
class AccountCreateContract final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_account_address();
...
class AccountPermissionUpdateContract final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::protocol::Permission* release_owner();
  ...
  PROTOBUF_MUST_USE_RESULT ::protocol::Permission* release_witness();
