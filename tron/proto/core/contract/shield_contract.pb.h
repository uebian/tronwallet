...
class MerklePath final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_rt();
...
class OutputPointInfo final :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_block_num() const;
  void _internal_set_block_num(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
...
class IncrementalMerkleTree final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::protocol::PedersenHash* release_left();
  ...
  PROTOBUF_MUST_USE_RESULT ::protocol::PedersenHash* release_right();
...
class IncrementalMerkleVoucher final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::protocol::IncrementalMerkleTree* release_tree();
  ...
  PROTOBUF_MUST_USE_RESULT ::protocol::IncrementalMerkleTree* release_cursor();
  ...
  PROTOBUF_MUST_USE_RESULT ::protocol::OutputPoint* release_output_point();
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_cursor_depth() const;
  void _internal_set_cursor_depth(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
...
class SpendDescription final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_value_commitment();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_anchor();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_nullifier();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_rk();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_zkproof();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_spend_authority_signature();
...
class ReceiveDescription final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_note_commitment();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_epk();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_c_enc();
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_c_out();
...
inline ::PROTOBUF_NAMESPACE_ID::int32 OutputPoint::_internal_index() const {
  return index_;
}
...
inline void OutputPoint::_internal_set_index(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 OutputPointInfo::_internal_block_num() const {
  return block_num_;
}
...
inline void OutputPointInfo::_internal_set_block_num(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 IncrementalMerkleVoucher::_internal_cursor_depth() const {
...
inline void IncrementalMerkleVoucher::_internal_set_cursor_depth(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ShieldedTransferContract::_internal_from_amount() const {
  return from_amount_;
}
...
inline void ShieldedTransferContract::_internal_set_from_amount(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 ShieldedTransferContract::_internal_to_amount() const {
  return to_amount_;
}
...
inline void ShieldedTransferContract::_internal_set_to_amount(::PROTOBUF_NAMESPACE_ID::int64 value) {
