...
class MarketSellAssetContract final :
 ...
 public:
  ...
  inline MarketSellAssetContract* New() const final {
    return new MarketSellAssetContract();
  }

  MarketSellAssetContract* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class MarketCancelOrderContract final :
 ...
 public:
  ...
  inline MarketCancelOrderContract* New() const final {
    return new MarketCancelOrderContract();
  }

  MarketCancelOrderContract* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 MarketSellAssetContract::_internal_sell_token_quantity() const {
  return sell_token_quantity_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 MarketSellAssetContract::sell_token_quantity() const {
...
inline void MarketSellAssetContract::_internal_set_sell_token_quantity(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  sell_token_quantity_ = value;
}
inline void MarketSellAssetContract::set_sell_token_quantity(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 MarketSellAssetContract::_internal_buy_token_quantity() const {
  return buy_token_quantity_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 MarketSellAssetContract::buy_token_quantity() const {
  // @@protoc_insertion_point(field_get:protocol.MarketSellAssetContract.buy_token_quantity)
  return _internal_buy_token_quantity();
}
inline void MarketSellAssetContract::_internal_set_buy_token_quantity(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  buy_token_quantity_ = value;
}
inline void MarketSellAssetContract::set_buy_token_quantity(::PROTOBUF_NAMESPACE_ID::int64 value) {
